 ...
 * @version $Id$
 */
var _, _buildJs, _buildJsDistMap, _uglify, _updateJsDistMap, amdclean, butil, color, config, errrHandler, filterDepMap, fs, gulp, gutil, header, info, jsDepBuilder, jsDistMapName, jsHash, jsToDist, md5, path, pkg, plumber, revall, rjs, rootPath, tryEval, uglify,
...
_buildJs = function(source, outName, cb) {
  var _content, _devPath, _distname, _hash, _jsHash, _oldPath, _source, content, mangled, outPath;
  _jsHash = {};
...
filterDepMap = function(depMap) {
  depMap = depMap.filter(function(dep) {
    return ["require", "exports", "module", "jquery", "smcore", "underscore", "cookie"].indexOf(dep) === -1;
  });
