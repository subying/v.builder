 ...
 *
 */
var lib_lazyload, lib_easing, lib_slide, mods_index_slider, utils_doajax, data_ibar, base_class, tpl_header, tpl_ggmod, mods_ggmod_poptips, mods_common_header, tpl_ibar, mods_ibar_tplinit, mods_ibar_main, mods_index_vmctrl, mods_index_main;
...
mods_index_main = function (lazyload, Slider, vmctrl) {
  var init;
  init = function () {
    Slider.init();
    $('img').lazyload({ placeholder: STATICPATH + 'img/dot.png' });
    return vmctrl.run(function () {
      return $(window).resize(function () {
        return $('#iBar').css({ 'height': $(window).height() });
      });
    });
  };
  return init();
