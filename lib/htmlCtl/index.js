...
* html模板构建和压缩模块
 */
var HtmlCtl, Utils, color, fs, gulpif, gutil, include, path, plumber, through2, vfs, _,
...
HtmlCtl = (function() {
  ...
  HtmlCtl.prototype._buildHtml = function() {
    ...
    _this = this;
    return through2.obj(function(file, enc, callback) {
      var e, _debugPath, _distPath, _name, _path, _source;
      try {
  ...
  HtmlCtl.prototype._buildSites = function() {
    ...
    _this = this;
    return through2.obj(function(file, enc, callback) {
      var e, outPath, site, siteArr, sitePath, _filePath;
      try {
