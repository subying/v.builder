...
define('_lib/lazyload', ['_lib/easing'], function() {
...
define('mods/index/slider', ['_lib/slider'], function() {
  ...
  exports.fullSlide = function() {
    ...
    _imgLoadimg = function(arr, funLoading, funOnLoad, funOnError) {
      var a, i, isObject, len, numError, numLoaded, preload, results, src;
    ...
    _loaded = function() {
      $fullSlide.hover(function() {
        return $fullSlide.find('.pnBtn').stop().fadeIn();
      }, function() {
        return $fullSlide.find('.pnBtn').fadeOut();
      });
